...
<trading_rules>
- ĐIỀU KIỆN VÀO LỆNH: Hợp lưu (plan_chinh / plan_phu) > 80% và đủ 3 yếu tố (Cấu trúc + CVD + Footprint); đối với scalp chỉ cần > 60%.
...
<field_definitions>
## Quy ước chung
- `hop_luu`: điểm hợp lưu 0–100. Quy tắc vào lệnh: chỉ xem xét "VÀO LỆNH" khi hop_luu >=80 và đủ 3 yếu tố (Cấu trúc + CVD + Footprint), đối với scalp chỉ cần >= 60.
