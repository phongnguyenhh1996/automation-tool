...
REM FULL_ANALYSIS GC1! (COMEX): TV watchlist GC1!, footprint native, Telegram only — no zones/EA/all-2
echo [%date% %time%] INFO: Starting coinmap-automation all --gocharting --gc-only
>> "%LOG_FILE%" echo [%date% %time%] INFO: Starting coinmap-automation all --gocharting --gc-only
coinmap-automation all --gocharting --gc-only %* >> "%LOG_FILE%" 2>&1
