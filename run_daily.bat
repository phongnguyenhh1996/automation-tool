...
REM Run full pipeline (headed: TradingView alert sync reliable vs headless)
echo [%date% %time%] INFO: Starting coinmap-automation all --headed>> "logs\daily.log"
coinmap-automation all --headed >> "logs\daily.log" 2>&1
