...
>> "%LOG_FILE%" echo [%date% %time%] capture --main-symbol EURUSD
coinmap-automation capture --main-symbol EURUSD >> "%LOG_FILE%" 2>&1
if errorlevel 1 (
...
>> "%LOG_FILE%" echo [%date% %time%] analyze --main-symbol EURUSD --mt5-dry-run --telegram-detail-chat-id -1003344625474
coinmap-automation analyze --main-symbol EURUSD --mt5-dry-run --telegram-detail-chat-id -1003344625474 >> "%LOG_FILE%" 2>&1
